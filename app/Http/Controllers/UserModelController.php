...
class UserModelController extends Controller
{
    ...
    {
        $data["title"] = "Profile";
        $data["data"] = UserModel::leftJoin('role_models', 'role_models.role_id', '=', 'user_models.role_id')->select()->where('user_models.user_id', '=', $user->user_id)->first();
    ...
    {
        if ($request->ajax()) {
            $data = UserModel::leftJoin('role_models', 'role_models.role_id', '=', 'user_models.role_id')->select()->orderBy('user_id', 'DESC')->get();
