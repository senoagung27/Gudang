...
class BarangkeluarController extends Controller
{
    public function index()
    {
        ...
        $data["hakTambah"] = AksesModel::leftJoin('submenu_models', 'submenu_models.submenu_id', '=', 'akses_models.submenu_id')->where(array('akses_models.role_id' => Session::get('user')->role_id, 'submenu_models.submenu_judul' => 'Barang Keluar', 'akses_models.akses_type' => 'create'))->count();
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $button = '';
                    $hakEdit = AksesModel::leftJoin('submenu_models', 'submenu_models.submenu_id', '=', 'akses_models.submenu_id')->where(array('akses_models.role_id' => Session::get('user')->role_id, 'submenu_models.submenu_judul' => 'Barang Keluar', 'akses_models.akses_type' => 'update'))->count();
                    $hakDelete = AksesModel::leftJoin('submenu_models', 'submenu_models.submenu_id', '=', 'akses_models.submenu_id')->where(array('akses_models.role_id' => Session::get('user')->role_id, 'submenu_models.submenu_judul' => 'Barang Keluar', 'akses_models.akses_type' => 'delete'))->count();
